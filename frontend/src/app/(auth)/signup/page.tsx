                    ...
                    {!otpStep ? (
                        <>
                            ...
                            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-6 flex items-start gap-3 animate-fade-in">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-red-500">Service Alert</h3>
                                    <p className="text-xs text-zinc-400 mt-1">OTP service is temporarily unavailable. Please use <span className="text-white font-bold">Google Login</span> to create your account.</p>
                                </div>
                            </div>
